/**
 * Parse Seneca's "On the Tranquillity of Mind" HTML into structured JSON entries.
 *
 * Source: https://vreeman.com/seneca/on-the-tranquillity-of-mind
 *
 * Output: data/seneca-tranquillity.json
 * Format: Array of { source: "seneca-tranquillity", book: number, entry: string, text: string, marked?: boolean }
 *   - book = chapter number (1-17)
 ...
 *   - 0 marked passages expected
 *
 * Usage: npx tsx scripts/parse-seneca-tranquillity.ts
 */
...
const SOURCE_URL = "https://vreeman.com/seneca/on-the-tranquillity-of-mind";
const OUTPUT_PATH = resolve(__dirname, "../data/seneca-tranquillity.json");
    ...
    if (tagName === "p") {
      ...
      if (strongEl.length > 0) {
        ...
        if (chapterMatch) {
          ...
          // Remove the chapter number prefix (e.g., "1 " or "17 ")
